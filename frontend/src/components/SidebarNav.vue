...
const menuItems = computed(() => {
  ...
  // Advisors and admins might see submissions differently or have extra items,
  // but for Phase 1 we will keep these core paths accessible to all authenticated users.
  items.push({
    name: 'Submissões',
    path: `/projects/1/submissions`, // Using an example ID for route linkage
